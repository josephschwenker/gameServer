...
class City {
    ...
    queueProduction(productionTarget) {
        game.active.productionQueue.push(new productionTarget());
    ...
    getTurnsLeft() {
        return Math.ceil((this.productionQueue[0].constructor.mineralCost - this.productionQueue[0].currentMinerals) / this.getTotalResource('minerals'));
    }
    build() {
        ...
        if (this.productionQueue.length != 0) {
            ...
            // update city status
            if (this.productionQueue.length != 0) {
                this.status = new CityStatus(this.productionQueue[0].constructor.fullName, this.getTurnsLeft());
            }
            else {
                this.status = status.noProduction;
            }
